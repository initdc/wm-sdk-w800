				  ...
				  unsigned char *key, uint32 keylen)
{
	...
	memset(ctx, 0x0, sizeof(psAesCipherContext_t));
/*
	setup cipher
 */
...
int32 psAesEncrypt(psAesCipherContext_t *ctx, unsigned char *pt,
...
int32 psAesDecrypt(psAesCipherContext_t *ctx, unsigned char *ct,
