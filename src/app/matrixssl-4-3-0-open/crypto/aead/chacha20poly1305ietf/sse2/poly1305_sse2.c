...
static int
psCrypto_onetimeauth_poly1305_sse2_init(crypto_onetimeauth_poly1305_state *state,
...
static int
psCrypto_onetimeauth_poly1305_sse2_update(
...
static int
psCrypto_onetimeauth_poly1305_sse2_final(crypto_onetimeauth_poly1305_state *state,
                                       unsigned char *                    out)
{
...
static int
psCrypto_onetimeauth_poly1305_sse2(unsigned char *out, const unsigned char *m,
                                 unsigned long long   inlen,
                                 const unsigned char *key)
{
...
static int
psCrypto_onetimeauth_poly1305_sse2_verify(const unsigned char *h,
                                        ...
                                        const unsigned char *k)
{
    ...
    psCrypto_onetimeauth_poly1305_sse2(correct, in, inlen, k);

    return psCrypto_verify_16(h, correct);
}

struct crypto_onetimeauth_poly1305_implementation
    psCrypto_onetimeauth_poly1305_sse2_implementation = {
        SODIUM_C99(.onetimeauth =) psCrypto_onetimeauth_poly1305_sse2,
        SODIUM_C99(.onetimeauth_verify =)
            psCrypto_onetimeauth_poly1305_sse2_verify,
        SODIUM_C99(.onetimeauth_init =) psCrypto_onetimeauth_poly1305_sse2_init,
        SODIUM_C99(.onetimeauth_update =)
            psCrypto_onetimeauth_poly1305_sse2_update,
        SODIUM_C99(.onetimeauth_final =) psCrypto_onetimeauth_poly1305_sse2_final
    };
