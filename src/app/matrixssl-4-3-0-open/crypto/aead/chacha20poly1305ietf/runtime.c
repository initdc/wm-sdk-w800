...
static int
psSodium_runtime_arm_cpu_features(CPUFeatures * const cpu_features)
{
# ifndef __arm__
...
static int
psSodium_runtime_intel_cpu_features(CPUFeatures * const cpu_features)
{
...
int
psSodium_runtime_get_cpu_features(void)
{
    int ret = -1;

    ret &= psSodium_runtime_arm_cpu_features(&_cpu_features);
    ret &= psSodium_runtime_intel_cpu_features(&_cpu_features);
...
int
psSodium_runtime_has_neon(void)
{
    return _cpu_features.has_neon;
}

int
psSodium_runtime_has_sse2(void)
{
    return _cpu_features.has_sse2;
}

int
psSodium_runtime_has_sse3(void)
{
    return _cpu_features.has_sse3;
}

int
psSodium_runtime_has_ssse3(void)
{
    return _cpu_features.has_ssse3;
}

int
psSodium_runtime_has_sse41(void)
{
    return _cpu_features.has_sse41;
}

int
psSodium_runtime_has_avx(void)
{
    return _cpu_features.has_avx;
}

int
psSodium_runtime_has_avx2(void)
{
    return _cpu_features.has_avx2;
}

int
psSodium_runtime_has_pclmul(void)
{
    return _cpu_features.has_pclmul;
}

int
psSodium_runtime_has_aesni(void)
{
