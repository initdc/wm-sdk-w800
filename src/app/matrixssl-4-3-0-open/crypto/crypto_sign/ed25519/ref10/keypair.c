...
int
psSodium_crypto_sign_ed25519_seed_keypair(unsigned char *pk, unsigned char *sk,
...
int
psSodium_crypto_sign_ed25519_keypair(unsigned char *pk, unsigned char *sk)
{
    unsigned char seed[32];
    int           ret;

    randombytes_buf(seed, sizeof seed);
    ret = psSodium_crypto_sign_ed25519_seed_keypair(pk, sk, seed);
...
int
psSodium_crypto_sign_ed25519_pk_to_curve25519(unsigned char *curve25519_pk,
...
int
psSodium_crypto_sign_ed25519_sk_to_curve25519(unsigned char *curve25519_sk,
