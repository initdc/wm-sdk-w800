...
static inline void
psSodium_fe25519_add(fe25519 h, const fe25519 f, const fe25519 g)
{
    int32_t h0 = f[0] + g[0];
    int32_t h1 = f[1] + g[1];
    int32_t h2 = f[2] + g[2];
...
psSodium_fe25519_sub(fe25519 h, const fe25519 f, const fe25519 g)
{
    int32_t h0 = f[0] - g[0];
    int32_t h1 = f[1] - g[1];
    int32_t h2 = f[2] - g[2];
...
static inline void
psSodium_fe25519_neg(fe25519 h, const fe25519 f)
{
    int32_t h0 = -f[0];
    int32_t h1 = -f[1];
    int32_t h2 = -f[2];
...
static void PSFUNC_UNUSED
psSodium_fe25519_cmov(fe25519 f, const fe25519 g, unsigned int b)
{
...
static void PSFUNC_UNUSED
psSodium_fe25519_cswap(fe25519 f, fe25519 g, unsigned int b)
{
...
static inline void
psSodium_fe25519_copy(fe25519 h, const fe25519 f)
{
    int32_t f0 = f[0];
    int32_t f1 = f[1];
    int32_t f2 = f[2];
...
static inline int
psSodium_fe25519_isnegative(const fe25519 f)
{
    unsigned char s[32];

    psSodium_fe25519_tobytes(s, f);
...
static inline int
psSodium_fe25519_iszero(const fe25519 f)
{
    unsigned char s[32];

    psSodium_fe25519_tobytes(s, f);

    return psSodium_is_zero(s, 32);
}
...
static void PSFUNC_UNUSED
psSodium_fe25519_mul(fe25519 h, const fe25519 f, const fe25519 g)
{
    int32_t f0 = f[0];
    int32_t f1 = f[1];
    int32_t f2 = f[2];
...
static void PSFUNC_UNUSED
psSodium_fe25519_sq(fe25519 h, const fe25519 f)
{
    int32_t f0 = f[0];
    int32_t f1 = f[1];
    int32_t f2 = f[2];
...
static void PSFUNC_UNUSED
psSodium_fe25519_sq2(fe25519 h, const fe25519 f)
{
    int32_t f0 = f[0];
    int32_t f1 = f[1];
    int32_t f2 = f[2];
...
static void PSFUNC_UNUSED
psSodium_fe25519_scalar_product(fe25519 h, const fe25519 f, uint32_t n)
{
