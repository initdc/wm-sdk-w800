...
static void _sha256_compress(psSha256Standalone_t *sha256, const unsigned char *buf)
# else
static void sha256_compress(psSha256Standalone_t *sha256, const unsigned char *buf)
# endif /* CLEAN_STACK */
{
...
# ifdef USE_BURN_STACK
static void sha256_compress(psSha256Standalone_t *sha256,
...
static int32_t psSha256StandaloneInit(psSha256Standalone_t *sha256)
{
# ifdef CRYPTO_ASSERT
...
static void psSha256StandaloneUpdate(psSha256Standalone_t *sha256,
...
static void psSha256StandaloneFinal(psSha256Standalone_t *sha256,
...
# ifdef CRYPTO_ASSERT
    ...
    {
        psTraceCrypto("psSha256StandaloneFinal error\n");
        return;
    }
# endif
...
# endif /* HAVE_NATIVE_INT64 */
    ...
    Memset(sha256, 0x0, sizeof(psSha256Standalone_t));
}

/* Compute SHA-256 hash of variable length input data. */
void psSha256Standalone(const void *data,
                        uint32_t len,
                        unsigned char hash[SHA256_HASHLEN])
{
    psSha256Standalone_t sha256_context;

    (void)psSha256StandaloneInit(&sha256_context);
    psSha256StandaloneUpdate(&sha256_context, data, len);
    psSha256StandaloneFinal(&sha256_context, hash);

#ifdef USE_BURN_STACK
    psBurnStack(sizeof(sha256_context) * 2);
#endif
}
