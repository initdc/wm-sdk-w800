/** osdep_nmmintrin.h
 *
 * Wrapper for system header osdep_nmmintrin.h
 */
...
/* This file just includes system header nmmintrin.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of nmmintrin.h, please
   customize this place holder header.
*/

#ifndef OSDEP_NMMINTRIN_H_DEFINED
#define OSDEP_NMMINTRIN_H_DEFINED 1
...
#endif /* OSDEP_NMMINTRIN_H_DEFINED */
