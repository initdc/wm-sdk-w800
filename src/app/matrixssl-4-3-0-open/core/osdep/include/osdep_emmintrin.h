/** osdep_emmintrin.h
 *
 * Wrapper for system header osdep_emmintrin.h
 */
...
/* This file just includes system header emmintrin.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of emmintrin.h, please
   customize this place holder header.
*/

#ifndef OSDEP_EMMINTRIN_H_DEFINED
#define OSDEP_EMMINTRIN_H_DEFINED 1
...
#endif /* OSDEP_EMMINTRIN_H_DEFINED */
