/** osdep_wchar.h
 *
 * Wrapper for system header osdep_wchar.h
 */
...
/* This file just includes system header wchar.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of wchar.h, please
   customize this place holder header.
*/

#ifndef OSDEP_WCHAR_H_DEFINED
#define OSDEP_WCHAR_H_DEFINED 1
