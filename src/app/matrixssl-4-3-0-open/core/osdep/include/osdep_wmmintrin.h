/** osdep_wmmintrin.h
 *
 * Wrapper for system header osdep_wmmintrin.h
 */
...
/* This file just includes system header wmmintrin.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of wmmintrin.h, please
   customize this place holder header. 
*/

#ifndef OSDEP_WMMINTRIN_H_DEFINED
#define OSDEP_WMMINTRIN_H_DEFINED 1
...
#endif /* OSDEP_WMMINTRIN_H_DEFINED */
