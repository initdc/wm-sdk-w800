/** osdep_intrin.h
 *
 * Wrapper for system header osdep_intrin.h
 */
...
/* This file just includes system header intrin.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of intrin.h, please
   customize this place holder header. 
*/

#ifndef OSDEP_INTRIN_H_DEFINED
#define OSDEP_INTRIN_H_DEFINED 1
