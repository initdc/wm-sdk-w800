/** osdep_sys_auxv.h
 *
 * Wrapper for system header osdep_sys_auxv.h
 */
...
/* This file just includes system header sys/auxv.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of sys/auxv.h, please
   customize this place holder header. 
*/

#ifndef OSDEP_SYS_AUXV_H_DEFINED
#define OSDEP_SYS_AUXV_H_DEFINED 1
...
#endif /* OSDEP_SYS_AUXV_H_DEFINED */
