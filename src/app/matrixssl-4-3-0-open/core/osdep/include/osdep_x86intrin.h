/** osdep_x86intrin.h
 *
 * Wrapper for system header osdep_x86intrin.h
 */
...
/* This file just includes system header x86intrin.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of x86intrin.h, please
   customize this place holder header.
*/

#ifndef OSDEP_X86INTRIN_H_DEFINED
#define OSDEP_X86INTRIN_H_DEFINED 1
...
#endif /* OSDEP_X86INTRIN_H_DEFINED */
