/** osdep_smmintrin.h
 *
 * Wrapper for system header osdep_smmintrin.h
 */
...
/* This file just includes system header smmintrin.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of smmintrin.h, please
   customize this place holder header.
*/

#ifndef OSDEP_SMMINTRIN_H_DEFINED
#define OSDEP_SMMINTRIN_H_DEFINED 1
...
#endif /* OSDEP_SMMINTRIN_H_DEFINED */
