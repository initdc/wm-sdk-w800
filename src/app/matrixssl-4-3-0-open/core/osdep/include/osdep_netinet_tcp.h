/** osdep_netinet_tcp.h
 *
 * Wrapper for system header osdep_netinet_tcp.h
 */
...
/* This file just includes system header netinet/tcp.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of netinet/tcp.h, please
   customize this place holder header.
*/

#ifndef OSDEP_NETINET_TCP_H_DEFINED
#define OSDEP_NETINET_TCP_H_DEFINED 1
...
#endif /* OSDEP_NETINET_TCP_H_DEFINED */
