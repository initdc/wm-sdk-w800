/** osdep_sys_types.h
 *
 * Wrapper for system header osdep_sys_types.h
 */
...
/* This file just includes system header sys/types.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of sys/types.h, please
   customize this place holder header.
*/

#ifndef OSDEP_SYS_TYPES_H_DEFINED
#define OSDEP_SYS_TYPES_H_DEFINED 1
...
#endif /* OSDEP_SYS_TYPES_H_DEFINED */
