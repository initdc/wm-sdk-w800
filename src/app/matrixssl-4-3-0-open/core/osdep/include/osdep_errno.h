/** osdep_errno.h
 *
 * Wrapper for system header osdep_errno.h
 */
...
/* This file just includes system header errno.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of errno.h, please
   customize this place holder header. 
*/

#ifndef OSDEP_ERRNO_H_DEFINED
#define OSDEP_ERRNO_H_DEFINED 1
