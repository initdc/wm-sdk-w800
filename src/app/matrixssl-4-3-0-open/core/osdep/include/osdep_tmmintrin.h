/** osdep_tmmintrin.h
 *
 * Wrapper for system header osdep_tmmintrin.h
 */
...
/* This file just includes system header tmmintrin.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of tmmintrin.h, please
   customize this place holder header. 
*/

#ifndef OSDEP_TMMINTRIN_H_DEFINED
#define OSDEP_TMMINTRIN_H_DEFINED 1
...
#endif /* OSDEP_TMMINTRIN_H_DEFINED */
