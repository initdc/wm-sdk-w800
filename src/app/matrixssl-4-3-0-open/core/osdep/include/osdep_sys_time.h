/** osdep_sys_time.h
 *
 * Wrapper for system header osdep_sys_time.h
 */
...
/* This file just includes system header sys/time.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of sys/time.h, please
   customize this place holder header. 
*/

#ifndef OSDEP_SYS_TIME_H_DEFINED
#define OSDEP_SYS_TIME_H_DEFINED 1
...
#endif /* OSDEP_SYS_TIME_H_DEFINED */
