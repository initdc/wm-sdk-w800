/** osdep_cpu-features.h
 *
 * Wrapper for system header osdep_cpu-features.h
 */
...
/* This file just includes system header cpu-features.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of cpu-features.h, please
   customize this place holder header.
*/

#ifndef OSDEP_CPU_FEATURES_H_DEFINED
#define OSDEP_CPU_FEATURES_H_DEFINED 1
...
#endif /* OSDEP_CPU_FEATURES_H_DEFINED */
