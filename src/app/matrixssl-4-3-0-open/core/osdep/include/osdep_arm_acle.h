/** osdep_arm_acle.h
 *
 * Wrapper for system header osdep_arm_acle.h
 */
...
/* This file just includes system header arm_acle.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of arm_acle.h, please
   customize this place holder header.
*/

#ifndef OSDEP_ARM_ACLE_H_DEFINED
#define OSDEP_ARM_ACLE_H_DEFINED 1
...
#endif /* OSDEP_ARM_ACLE_H_DEFINED */
