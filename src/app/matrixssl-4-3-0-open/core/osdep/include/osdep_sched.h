/** osdep_sched.h
 *
 * Wrapper for system header osdep_sched.h
 */
...
/* This file just includes system header sched.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of sched.h, please
   customize this place holder header.
*/

#ifndef OSDEP_SCHED_H_DEFINED
#define OSDEP_SCHED_H_DEFINED 1
