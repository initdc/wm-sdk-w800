/** osdep_immintrin.h
 *
 * Wrapper for system header osdep_immintrin.h
 */
...
/* This file just includes system header immintrin.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of immintrin.h, please
   customize this place holder header.
*/

#ifndef OSDEP_IMMINTRIN_H_DEFINED
#define OSDEP_IMMINTRIN_H_DEFINED 1
...
#endif /* OSDEP_IMMINTRIN_H_DEFINED */
