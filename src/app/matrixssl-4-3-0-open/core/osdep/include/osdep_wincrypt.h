/** osdep_wincrypt.h
 *
 * Wrapper for system header osdep_wincrypt.h
 */
...
/* This file just includes system header wincrypt.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of wincrypt.h, please
   customize this place holder header.
*/

#ifndef OSDEP_WINCRYPT_H_DEFINED
#define OSDEP_WINCRYPT_H_DEFINED 1
...
#endif /* OSDEP_WINCRYPT_H_DEFINED */
