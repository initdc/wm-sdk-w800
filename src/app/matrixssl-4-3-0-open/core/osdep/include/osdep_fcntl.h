/** osdep_fcntl.h
 *
 * Wrapper for system header osdep_fcntl.h
 */
...
/* This file just includes system header fcntl.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of fcntl.h, please
   customize this place holder header.
*/

#ifndef OSDEP_FCNTL_H_DEFINED
#define OSDEP_FCNTL_H_DEFINED 1
