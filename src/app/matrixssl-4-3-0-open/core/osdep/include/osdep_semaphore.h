/** osdep_semaphore.h
 *
 * Wrapper for system header osdep_semaphore.h
 */
...
/* This file just includes system header semaphore.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of semaphore.h, please
   customize this place holder header.
*/

#ifndef OSDEP_SEMAPHORE_H_DEFINED
#define OSDEP_SEMAPHORE_H_DEFINED 1
...
#endif /* OSDEP_SEMAPHORE_H_DEFINED */
