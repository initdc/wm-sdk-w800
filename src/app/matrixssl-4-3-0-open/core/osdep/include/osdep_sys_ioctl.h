/** osdep_sys_ioctl.h
 *
 * Wrapper for system header osdep_sys_ioctl.h
 */
...
/* This file just includes system header sys/ioctl.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of sys/ioctl.h, please
   customize this place holder header.
*/

#ifndef OSDEP_SYS_IOCTL_H_DEFINED
#define OSDEP_SYS_IOCTL_H_DEFINED 1
...
#endif /* OSDEP_SYS_IOCTL_H_DEFINED */
