/** osdep_sys_mman.h
 *
 * Wrapper for system header osdep_sys_mman.h
 */
...
/* This file just includes system header sys/mman.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of sys/mman.h, please
   customize this place holder header. 
*/

#ifndef OSDEP_SYS_MMAN_H_DEFINED
#define OSDEP_SYS_MMAN_H_DEFINED 1
...
#endif /* OSDEP_SYS_MMAN_H_DEFINED */
