/** osdep_zmmintrin.h
 *
 * Wrapper for system header osdep_zmmintrin.h
 */
...
/* This file just includes system header zmmintrin.h.
   In case your system does not include all functions
    via that file or
   does not have implementation of zmmintrin.h, please
   customize this place holder header.
*/

#ifndef OSDEP_ZMMINTRIN_H_DEFINED
#define OSDEP_ZMMINTRIN_H_DEFINED 1
...
#endif /* OSDEP_ZMMINTRIN_H_DEFINED */
